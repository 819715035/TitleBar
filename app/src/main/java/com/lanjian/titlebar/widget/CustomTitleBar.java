package com.lanjian.titlebar.widget;
...
import com.lanjian.titlebar.DensityUtil;
import com.lanjian.titlebar.R;
...
public class CustomTitleBar extends RelativeLayout implements View.OnClickListener {
    ...
    private void initView(TypedArray array) {
        ...
        leftTextSize1 = array.getDimension(R.styleable.CustomTitleBar_leftTextSize1, DensityUtil.dip2px(getContext(), 15));
        leftTextSize2 = array.getDimension(R.styleable.CustomTitleBar_leftTextSize2, DensityUtil.dip2px(getContext(), 15));
        rightTextSize1 = array.getDimension(R.styleable.CustomTitleBar_rightTextSize1, DensityUtil.dip2px(getContext(), 17));
        rightTextSize2 = array.getDimension(R.styleable.CustomTitleBar_rightTextSize2, DensityUtil.dip2px(getContext(), 17));
    ...
    public void setLeftImage1(int leftImage) {
        ...
        tvLeft1.setCompoundDrawablePadding(DensityUtil.dip2px(getContext(), 8));
    ...
    public void setLeftImage2(int leftImage) {
        ...
        Drawable drawable = getResources().getDrawable(leftImage);
        drawable.setBounds(0, 0, drawable.getMinimumWidth(), drawable.getMinimumHeight());
        tvLeft2.setCompoundDrawablePadding(DensityUtil.dip2px(getContext(), 8));
    ...
    public void setRightImage2(int rightImage2) {
        ...
        drawable.setBounds(0, 0, drawable.getMinimumWidth(), drawable.getMinimumHeight());
        tvRight2.setCompoundDrawablePadding(DensityUtil.dip2px(getContext(), 8));
    ...
    public void setRightImage1(int rightImage1) {
        ...
        drawable.setBounds(0, 0, drawable.getMinimumWidth(), drawable.getMinimumHeight());
        tvRight1.setCompoundDrawablePadding(DensityUtil.dip2px(getContext(), 8));
