...
public class CustomTitleBar extends RelativeLayout implements View.OnClickListener {
    ...
    private void initView(TypedArray array) {
        ...
        tvRight = (TitleTextView) findViewById(R.id.tvRightTitle);
        ...
        tvRight.setDrawableLeftListener(new TitleTextView.DrawableLeftListener() {
            @Override
        ...
        tvRight.setDrawableRightListener(new TitleTextView.DrawableRightListener() {
            @Override
